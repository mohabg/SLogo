...
public class GUI {
	...
	public Scene init() {
		...
		Scene myScene = new Scene(root, getScreenWidth(), getScreenHeight());
	...
	/*
	 * public static Point2D getScreenCenter () { Screen screen =
	 * Screen.getPrimary(); Rectangle2D bounds = screen.getVisualBounds();
	 * double screenWidth = bounds.getWidth(); double screenHeight =
	 * bounds.getHeight(); return (new Point2D(screenWidth / 2, screenHeight /
	 * 2)); }
	 */
